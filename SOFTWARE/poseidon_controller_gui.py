...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.p2_incremental_DISP.setDigitCount(7)
        ...
        self.p3_remain_DISP.setDigitCount(7)
        ...
        self.p3_incremental_DISP.setDigitCount(7)
        ...
        self.p2_absolute_DISP.setDigitCount(7)
        ...
        self.p1_remain_DISP.setDigitCount(7)
        ...
        self.p1_incremental_DISP.setDigitCount(7)
        ...
        self.p3_absolute_DISP.setDigitCount(7)
        ...
        self.p2_remain_DISP.setDigitCount(7)
        ...
        self.p1_absolute_DISP.setDigitCount(7)
        ...
        self.gridLayout.addWidget(self.p1_setup_send_BTN, 1, 7, 1, 1)
        ...
        self.gridLayout.addWidget(self.p2_setup_send_BTN, 2, 7, 1, 1)
        ...
        self.gridLayout.addWidget(self.p3_setup_send_BTN, 3, 7, 1, 1)
        ...
        self.TTLSettingLabel = QtWidgets.QLabel(self.setup)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.TTLSettingLabel.setFont(font)
        self.TTLSettingLabel.setWordWrap(False)
        self.TTLSettingLabel.setObjectName("TTLSettingLabel")
        self.gridLayout.addWidget(self.TTLSettingLabel, 0, 6, 1, 1)
        self.TTL1 = QtWidgets.QCheckBox(self.setup)
        self.TTL1.setObjectName("TTL1")
        self.gridLayout.addWidget(self.TTL1, 1, 6, 1, 1)
        self.TTL2 = QtWidgets.QCheckBox(self.setup)
        self.TTL2.setObjectName("TTL2")
        self.gridLayout.addWidget(self.TTL2, 2, 6, 1, 1)
        self.TTL3 = QtWidgets.QCheckBox(self.setup)
        self.TTL3.setObjectName("TTL3")
        self.gridLayout.addWidget(self.TTL3, 3, 6, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.TTLSettingLabel.setText(_translate("MainWindow", "<html><head/><body><p>TTL</p><p>Trigger</p></body></html>"))
        self.TTL1.setText(_translate("MainWindow", "Enable"))
        self.TTL2.setText(_translate("MainWindow", "Enable"))
        self.TTL3.setText(_translate("MainWindow", "Enable"))
